...
<div class="s-results">
	...
	<c:if test="${searchMap['listApproxSize'] > 0 || moduleMap['listTotalSize'] > 0}">
        ...
        <span class="results-number"><fmt:message key="search.results.sizeNotExact.found"><fmt:param value="${fn:escapeXml(param[termKey])}"/><fmt:param value="more"/></fmt:message></span>
        </c:if>
        ...
        <span class="results-number"><fmt:message key="${messKey}"><fmt:param value="${fn:escapeXml(param[termKey])}"/><fmt:param value="${searchMap['listApproxSize'] > 0 ? searchMap['listApproxSize'] : moduleMap['listTotalSize']}"/></fmt:message></span>
        </c:if>
