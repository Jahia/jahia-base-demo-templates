...
<c:if test="${not empty pdfVersion}">
    <div>${pdfVersion.node.name} <a class="view-pdf" href="${pdfVersion.node.url}"><strong><i class="fa fa-fw fa-eye" title="view"></i></strong></a>&nbsp;<a href="${pdfVersion.node.url}"><strong><i class="fa fa-download" title="<fmt:message key="label.download"/>"></i></strong> </a>
